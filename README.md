...
```shell
docker  build --platform amd64  --tag paperless:local  .  --build-arg HTTPS_PROXY=http://192.168.200.24:7890 --build-arg BUILDPLATFORM=linux/amd64 --build-arg TARGETARCH=amd64
```